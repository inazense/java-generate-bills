...
import utils.PDFPrintPage;

/**
 * Class used to send pdf files to printer.
 * It is not my code. This is programmed by @venkatsalem -> https://github.com/venkatsalem/print-pdf
 * @author Inazio
 *
 */
public class PdfPrinter {
	 ...
	 */
	public PdfPrinter(InputStream inputStream, String jobName) throws IOException, PrinterException {
	 ...
	 * @throws PrinterException
	 */
	public PdfPrinter(byte[] content, String jobName) throws IOException, PrinterException {
